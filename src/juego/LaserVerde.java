...
public class LaserVerde {
	...
	private Hitbox hitboxLaserVerde;
    
    public LaserVerde(double x, double y, double velocidad, double maxVel, double angle, int ancho, int alto, Image imagen, Hitbox hitboxLaser) {
        this.x = x;
        this.y = y;
        this.angle = angle;
        ...
        this.alto = alto;
        this.imagen = imagen;
        this.hitboxLaserVerde=hitboxLaser;
    }  
    ...
    public void mover() {
        ...
        hitboxLaserVerde.setX(x += velocidad * Math.cos(angle));
        hitboxLaserVerde.setY( y += velocidad * Math.sin(angle));
    ...
    public void dibujarImagen(Entorno e){
    	...
    	hitboxLaserVerde.dibujarHitbox(e);
    ...
    public void colisionLaserVyLaserR(List<LaserRojo> lasers) {
    	for(LaserRojo l: lasers) {
    		if(l.getX() + l.getAncho()/2 <= hitboxLaserVerde.getX()+ hitboxLaserVerde.getAncho()/2 
    				&& l.getX() - l.getAncho()/2 >= hitboxLaserVerde.getX() - hitboxLaserVerde.getAncho()/2 &&
    				l.getY() - l.getAlto()/2 >= hitboxLaserVerde.getY()- hitboxLaserVerde.getAlto()/2 &&
    				l.getY() + l.getAlto()/2 <= hitboxLaserVerde.getY()+ hitboxLaserVerde.getAlto()/2) {
